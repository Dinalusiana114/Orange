...
WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/a_Pay Grades'))

WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/h6_Pay Grades'))
