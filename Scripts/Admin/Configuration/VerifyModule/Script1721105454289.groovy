...
WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/li_Modules'))

WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/h6_Module Configuration'))
