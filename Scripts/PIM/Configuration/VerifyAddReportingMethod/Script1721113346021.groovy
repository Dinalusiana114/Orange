...
WebUI.click(findTestObject('Object Repository/PIM/Page_OrangeHRM/a_Reporting Methods'))

WebUI.click(findTestObject('Object Repository/PIM/Page_OrangeHRM/p_Reporting Methods'))

WebUI.click(findTestObject('Object Repository/PIM/Page_OrangeHRM/div_Name'))
...
WebUI.click(findTestObject('Object Repository/PIM/Page_OrangeHRM/p_Add Reporting Method'))

WebUI.click(findTestObject('Object Repository/PIM/Page_OrangeHRM/label_Name'))

WebUI.setText(findTestObject('Object Repository/PIM/Page_OrangeHRM/input_Password_password'), 'name')
