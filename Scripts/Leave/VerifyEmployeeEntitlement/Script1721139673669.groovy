...
WebUI.click(findTestObject('Object Repository/Leave/Page_OrangeHRM/li_Employee Entitlements'))

WebUI.click(findTestObject('Object Repository/Leave/Page_OrangeHRM/h5_Leave Entitlements'))
