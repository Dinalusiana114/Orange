...
WebUI.click(findTestObject('Object Repository/Leave/Page_OrangeHRM/a_Apply'))

WebUI.click(findTestObject('Object Repository/Leave/Page_OrangeHRM/h6_Apply Leave'))
...
WebUI.click(findTestObject('Object Repository/Leave/Page_OrangeHRM/label_Comments'))

WebUI.click(findTestObject('Object Repository/Leave/Page_OrangeHRM/p_Required'))

WebUI.click(findTestObject('Object Repository/Leave/Page_OrangeHRM/label_Leave Balance'))

WebUI.click(findTestObject('Object Repository/Leave/Page_OrangeHRM/button_Apply'))
